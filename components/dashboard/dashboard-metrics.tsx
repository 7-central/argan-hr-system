import { Calendar, PieChart, PoundSterling, Users } from 'lucide-react';

import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';

import { getDashboardMetrics } from '@/app/admin/(protected)/actions';
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">Tier 1 / Doc Only / Ad-hoc</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">
            £
            {totalMonthlyRevenue.toLocaleString('en-GB', {
              minimumFractionDigits: 0,
              maximumFractionDigits: 0,
            })}
          </div>
          <p className="text-xs text-muted-foreground">Total monthly retainer value</p>
        </CardContent>
      </Card>
