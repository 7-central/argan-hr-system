...
export function ContractInfoContent({ contract, formatDate }: ContractInfoContentProps) {
  if (!contract) {
    return (
      <Card>
        ...
        <CardContent>
          <div className="grid gap-6 md:grid-cols-2">
            <div>
              ...
              <p className="text-lg mt-1">
                £{contract.hrAdminRate || '0'} {contract.hrAdminRateUnit === 'HOURLY' ? 'per hour' : 'per day'}
              </p>
            </div>
            <div>
              <p className="text-sm font-medium text-muted-foreground">Employment Law Rate</p>
              <p className="text-lg mt-1">
                £{contract.employmentLawRate || '0'} {contract.employmentLawRateUnit === 'HOURLY' ? 'per hour' : 'per day'}
              </p>
            </div>
            <div>
              <p className="text-sm font-medium text-muted-foreground">Mileage Rate</p>
              <p className="text-lg mt-1">£{contract.mileageRate || '0'} per mile</p>
            </div>
            <div>
              <p className="text-sm font-medium text-muted-foreground">Overnight Rate</p>
              <p className="text-lg mt-1">£{contract.overnightRate || '0'} per night</p>
            </div>
          </div>
        </CardContent>
      </Card>
