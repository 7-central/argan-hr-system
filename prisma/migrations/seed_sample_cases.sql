...
INSERT INTO cases (
  ...
  status, action_required_by, created_at, updated_at
) VALUES (
  'CASE-0005', 1,
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0005' AND client_id = 1),
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0006' AND client_id = 3),
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0007' AND client_id = 3),
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0008' AND client_id = 3),
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0009' AND client_id = 4),
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0010' AND client_id = 4),
  'Peter Marland', 'CLIENT', 'Kimberley Fallon', 'ARGAN',
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0011' AND client_id = 4),
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0012' AND client_id = 5),
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0013' AND client_id = 5),
  'Peter Marsden', 'CLIENT', 'Kimberley Fallon', 'ARGAN',
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0014' AND client_id = 5),
...
INSERT INTO case_interactions (
  ...
  (SELECT id FROM cases WHERE case_id = 'CASE-0015' AND client_id = 5),
